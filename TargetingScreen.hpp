...
class TargetingScreen : public BaseSystem, BaseState
{
public:
	TargetingScreen(StateManager& _state_manager, World& _world, EventManager& _event_manager, Keyboard& _keyboard);
	~TargetingScreen();
