...
Window::Window() :
	context(nullptr, SDL_DestroyWindow), renderer(nullptr, SDL_DestroyRenderer), title(""), width(0), height(0), default_width(0), default_height(0), tile_width(0), tile_height(0)
{
